...
HOME=strcat(pwd,'/');
pathPrincipal=strcat(HOME,'SoyResults/byDisease/SetCreator/');
...
pathEntradaImagenesMarcas=strcat(HOME,'SoyResults/inputMarked/');
pathEntradaImagenesTest=strcat(HOME,'SoyResults/inputTest/');
